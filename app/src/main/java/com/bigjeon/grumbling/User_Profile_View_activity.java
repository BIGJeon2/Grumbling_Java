...
public class User_Profile_View_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.setPostSettingBinding(this);
        ...
        if (!User_Uid.equals(My_Uid)){
            Set_Users_Data();
            binding.ShowUserProfileBtnsContainer.setVisibility(View.GONE);
            ...
            public void onComplete(@NonNull @NotNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()){
                    for (QueryDocumentSnapshot document : task.getResult()){
                        ...
                        binding.SettingFragmentMyUidTv.setText(document.get("UID").toString());
                        break;
                    }
                }
            }
